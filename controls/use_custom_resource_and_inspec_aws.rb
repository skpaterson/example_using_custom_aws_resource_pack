...
title "Example of InSpec AWS and a custom resource"

# Use the custom resource from the resource pack we depend on via inspec.yml

describe aws_custom_resource_example do
  it { should exist }
end

# Below here is the automatically generated example from "inspec profile init profile --platform aws"
